			...
			component.dropzone.on('queuecomplete', function() {
				if(component.bundle.files.length > 0) {
					$.post('/upload/bundle', {
						...
						$(DROPZONE_PREVIEW_TEMPLATE_SELECTOR).prepend('<div class="dz-preview-bundle"><span class="glyphicon glyphicon-download-alt"></span> <a href="/bundle/' + component.bundle.id + '/">https://transfer.mediamonks.net/bundle/'+component.bundle.id+'/</a></div>');
						component.$completedContainer
								 .find('form')
